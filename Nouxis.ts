 ...
 * IDL can be found at `target/idl/Nouxis.json`.
 */
export type Nouxis = {
  "address": "NouXXXZsWXpanM5UzshMKZH4wUbeFNcxPWnFyTBgRP1",
  "metadata": {
    "name": "Nouxis",
    "version": "0.1.0",
    "spec": "0.1.0",
    "description": "Nouxis Protocol — Agent identity, reputation, delegation, and NouX payment settlement on Solana"
  },
  "instructions": [
    {
      "name": "addService",
  ...
  "errors": [
    ...
    {
      "code": 6047,
      "name": "selfDelegationAdminDenied",
      "msg": "Self-service delegations cannot grant admin permissions"
    },
    {
      "code": 6048,
      "name": "selfDelegationRequiresBudget",
      "msg": "Self-service delegations must have a spend limit (max_spend_total > 0)"
    },
    {
      "code": 6049,
    ...
    },
    {
      ...
      "msg": "Vault does not have sufficient funds for this payment"
    },
    {
      "code": 6054,
      "name": "vaultNotFunded",
      "msg": "Delegation vault has not been funded"
    }
  ],
  "types": [
    {
